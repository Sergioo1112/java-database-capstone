...
public class Doctor 
{
	...
	public void setSpecialty(String _specialty) {this.specialty = _specialty;}
	...
	public void setAvailableTimes(List<String> _availableTimes) {this.availableTimes = _availableTimes;}
